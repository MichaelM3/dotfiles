...
# exports 210
export APPDIR=/opt/t3code-bin
export BACKGROUND='#1e1e2e'
export BORDER_BACKGROUND='#1e1e2e'
export BORDER_FOREGROUND='#89b4fa'
export CHROME_DESKTOP=t3code.desktop
export CLICOLOR=1
export CODEX_CLI_PATH=/home/unbalanced/.local/share/mise/shims/codex
export CODEX_HOME=/home/unbalanced/.codex
...
export GSETTINGS_SCHEMA_DIR=/opt/t3code-bin/usr/share/glib-2.0/schemas
...
export INVOCATION_ID=39c14ca253cb4d76a3b353c545cb760c
export JOURNAL_STREAM=9:14621
...
export MANWIDTH=999
export MEMORY_PRESSURE_WATCH=/sys/fs/cgroup/user.slice/user-1000.slice/user@1000.service/app.slice/elephant.service/memory.pressure
...
export XDG_DATA_DIRS=/opt/t3code-bin/usr/share:/usr/local/share:/usr/share
