...
alias tmux_react="reactflow.sh"
# alias dev="cd /Volumes/Seagate/Development/"
alias dev="cd ~/Development/"
alias goudemy="cd ~/Development/go/src/github.com/michaelm3/"
alias nvimconf="~/.config/nvim && nvim ."
